					...
					"application/json": {
						schema: openApiZ.object({
							data: openApiZ.object({
								...
								triggerPrTitle: openApiZ.string().nullable(),
								triggerSourceBranch: openApiZ.string().nullable(),
								triggerTargetBranch: openApiZ.string().nullable(),
								triggerPrAuthorName: openApiZ.string().nullable(),
								triggerPrAuthorUsername: openApiZ.string().nullable(),
								triggerPrAuthorAvatarUrl: openApiZ.string().nullable(),
								triggerMeta: openApiZ.unknown(),
								docsAffected: openApiZ.boolean().nullable(),
								suggestionsCount: openApiZ.number(),
